...
export const WorkoutRoutineInputSchema = z.object({
  ...
  skills: z.array(z.string()).optional().describe("A list of specific, high-level skills the user wants to learn (e.g., 'Planche', 'Front Lever', 'Run a 5k'). This can include predefined skills or custom ones from an 'other' field."),
